...
#define RED_NS_Pin GPIO_PIN_7
#define RED_NS_GPIO_Port GPIOA
#define YELLOW_NS_Pin GPIO_PIN_0
#define YELLOW_NS_GPIO_Port GPIOB
#define GREEN_NS_Pin GPIO_PIN_1
#define GREEN_NS_GPIO_Port GPIOB
#define RED_EW_Pin GPIO_PIN_2
#define RED_EW_GPIO_Port GPIOB
#define YELLOW_EW_Pin GPIO_PIN_10
#define YELLOW_EW_GPIO_Port GPIOB
#define GREEN_EW_Pin GPIO_PIN_11
